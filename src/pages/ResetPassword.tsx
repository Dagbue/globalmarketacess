...
import { Eye, EyeOff, Sparkles, Shield, Check, Zap } from 'lucide-react';
          ...
          <div className="relative z-10 flex flex-col justify-center px-16 py-20">
            ...
            <div className="space-y-6 mb-12">
              <div
                ...
                <span className="text-blue-300 font-semibold text-sm">Create a Strong Password</span>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Strong Encryption</h3>
                  <p className="text-slate-400 text-sm">Your password is encrypted & secured</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg mb-1">Best Practices</h3>
                  <p className="text-slate-400 text-sm">Use 8+ characters with mixed case & numbers</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">Sign in immediately after reset</p>
                </div>
              </div>
            </div>
          </div>
