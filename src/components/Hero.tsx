  ...
  return (
    <section className="relative min-h-screen pt-24 pb-32 px-6 bg-slate-950 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/3 w-[900px] h-[900px] bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-full blur-[120px]"></div>
        <div className="absolute top-1/2 right-1/4 w-[800px] h-[800px] bg-gradient-to-l from-blue-600/8 to-blue-400/8 rounded-full blur-[100px] animate-float"></div>
        <div className="absolute bottom-1/4 left-1/2 w-[700px] h-[700px] bg-gradient-to-br from-cyan-500/6 to-blue-700/6 rounded-full blur-[80px]"></div>
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#0066ff03_1px,transparent_1px),linear-gradient(to_bottom,#0066ff03_1px,transparent_1px)] bg-[size:64px_64px]"></div>
      </div>
        ...
        <div className="grid grid-cols-12 gap-6 items-start">
          ...
          <div className="col-span-12 lg:col-span-7 space-y-8 relative z-10">
            ...
            <div className="inline-block" style={{ transform: 'rotate(-2deg)' }}>
              <div className="glass-strong backdrop-blur-2xl border border-blue-400/30 rounded-full px-6 py-3 shadow-[0_0_20px_rgba(0,102,255,0.2)]">
            ...
            <div className="space-y-4">
              <div className="glass backdrop-blur-xl border border-blue-500/20 rounded-3xl p-8 shadow-[0_0_20px_rgba(0,102,255,0.15)] animate-float">
              ...
              <div className="relative ml-12" style={{ transform: 'rotate(1deg)' }}>
                <div className="glass-card backdrop-blur-2xl border border-cyan-400/20 rounded-2xl p-6 shadow-[0_0_20px_rgba(0,204,255,0.2)] animate-float">
            ...
            <div className="relative pt-6">
              ...
              <div className="relative z-20" style={{ transform: 'rotate(-1deg)' }}>
                <button
                  onClick={() => handleBack()}
                  className="group relative px-12 py-6 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 text-white rounded-2xl font-black text-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(0,102,255,0.8)] w-full sm:w-auto">
              ...
              <div className="absolute -bottom-8 left-0 right-0 flex gap-4 z-10">
                <div className="glass-strong backdrop-blur-xl border border-blue-400/30 rounded-xl px-6 py-4 flex items-center space-x-3 shadow-[0_0_15px_rgba(0,102,255,0.2)] flex-1">
                  <Zap className="w-6 h-6 text-cyan-400" />
                  <span className="text-slate-200 font-bold">0.01s Execution</span>
                </div>
                <div className="glass-strong backdrop-blur-xl border border-cyan-400/30 rounded-xl px-6 py-4 flex items-center space-x-3 shadow-[0_0_15px_rgba(0,204,255,0.2)] flex-1">
            ...
            <div className="grid grid-cols-3 gap-4 pt-16">
              <div className="glass backdrop-blur-xl border border-blue-500/20 rounded-2xl p-6 text-center hover:scale-105 transition-all animate-float">
              ...
              <div className="glass backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 text-center hover:scale-105 transition-all animate-float">
          ...
          <div className="col-span-12 lg:col-span-5 relative">
            {/* Background Glow */}
            <div className="absolute -inset-8 bg-gradient-to-br from-blue-500/10 via-cyan-500/8 to-blue-600/10 rounded-[3rem] blur-[60px]"></div>
            ...
            <div className="relative space-y-6">
              ...
              <div className="relative z-30" style={{ transform: 'rotate(-1.5deg)' }}>
                <div className="glass-strong backdrop-blur-2xl rounded-3xl border border-blue-400/40 shadow-[0_0_20px_rgba(0,102,255,0.4)] overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5"></div>
                  <div className="absolute inset-0 bg-[linear-gradient(to_right,#0066ff03_1px,transparent_1px),linear-gradient(to_bottom,#0066ff03_1px,transparent_1px)] bg-[size:40px_40px]"></div>

                  <div className="relative p-8">
                    <div className="flex items-center justify-between mb-8">
                      <div className="flex items-center space-x-4">
                        <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-[0_0_15px_rgba(0,102,255,0.5)]">
              ...
              <div className="relative z-20 -mt-12 ml-8" style={{ transform: 'rotate(1deg)' }}>
                <div className="glass-card backdrop-blur-2xl border border-cyan-400/30 rounded-3xl p-8 shadow-[0_0_20px_rgba(0,204,255,0.3)] animate-float">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-3">
                      <TrendingUp className="w-6 h-6 text-cyan-400" />
                      <span className="text-white font-black text-lg">Hot Assets</span>
                    </div>
                    <div className="px-4 py-1.5 bg-gradient-to-r from-green-500/20 to-cyan-500/20 text-cyan-300 rounded-full text-xs font-black border border-cyan-400/40">
                      TRENDING
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={asset.ticker}
                           className="glass backdrop-blur-xl border border-blue-400/20 rounded-2xl p-4 hover:border-cyan-400/40 transition-all hover:shadow-[0_0_15px_rgba(0,204,255,0.2)] group">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-[0_0_10px_rgba(0,102,255,0.3)] group-hover:scale-110 transition-transform">
              ...
              <div className="relative z-10 -mt-8 -ml-6" style={{ transform: 'rotate(-0.5deg)' }}>
                <div className="glass-strong backdrop-blur-2xl border border-blue-500/30 rounded-3xl p-8 shadow-[0_0_15px_rgba(0,102,255,0.25)]">
