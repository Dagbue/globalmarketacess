...
export default function PlaceTrade() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (userEmail === 'vmeht87@gmail.com') {
      setShowMomentumWarning(true);
      return;
    }
