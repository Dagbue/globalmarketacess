...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    quote: "Started with zero trading experience. Market Signal Trades educational resources and demo account helped me learn the basics. Now I'm consistently profitable with forex trading.",
    profitPercent: "+156%",
  ...
  },
  {
    ...
    joinedDate: "May 2024",
    rating: 5,
    quote: "At 65, I thought it was too late to start trading. Market Signal Trades copy trading feature allowed me to follow successful traders while learning. Now I have a steady income stream.",
    profitPercent: "+412%",
  ...
  },
  {
    ...
    rating: 5,
    quote: "As someone deeply involved in blockchain technology, I appreciate Market Signal Trades commitment to innovation. The crypto derivatives market access is unmatched.",
    profitPercent: "+445%",
    profitPeriod: "1 year",
    tradesCount: "1,800+",
    startedWith: "$30,000",
  ...
  },
  {
    ...
    rating: 5,
    quote: "Lightning-fast execution is critical for day trading. Market Signal Trades delivers with zero slippage on most trades. The analytics dashboard provides real-time insights I need.",
    profitPercent: "+612%",
  ...
  },
  {
    ...
    rating: 5,
    quote: "Been in crypto since 2017. Market Signal Trades offers the best crypto CFD trading experience with leverage options and hedging strategies unavailable on regular exchanges.",
    profitPercent: "+678%",
  ...
  },
  {
    ...
    rating: 5,
    quote: "Managing client portfolios requires reliability and precision. Market Signal Trades multi-account management and reporting tools streamline my workflow significantly.",
    profitPercent: "+845%",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Real Stories from <span className="text-blue-600">Real Traders</span>
          </h2>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 mb-8">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-2 px-5 py-2.5 bg-white border border-gray-300 rounded-lg hover:border-gray-400 transition-all"
            >
            ...
            {showRatingFilter && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-xl z-10">
                ...
                >
                  ...
                  {!selectedRating && <Check className="w-4 h-4 text-blue-600" />}
                </button>
                {[5, 4].map(rating => (
                  <button
                    key={rating}
                  ...
                  >
                    ...
                    {selectedRating === rating && <Check className="w-4 h-4 text-blue-600" />}
                  </button>
                ))}
              </div>
            )}
          ...
          {filteredTestimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-gray-500">Joined {testimonial.joinedDate}</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-100">
                <div className="bg-green-50 rounded-lg p-3 text-center">
                  <div className="text-xl font-bold text-green-600">{testimonial.profitPercent}</div>
                  <div className="text-xs text-gray-600">Profit</div>
                </div>
                <div className="bg-blue-50 rounded-lg p-3 text-center">
                  <div className="text-xl font-bold text-blue-600">{testimonial.profitPeriod}</div>
              ...
              <div className="grid grid-cols-2 gap-3 mt-3">
                <div className="bg-gray-50 rounded-lg p-3 text-center">
                  <div className="text-base font-bold text-gray-900">{testimonial.tradesCount}</div>
                  <div className="text-xs text-gray-600">Trades</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-3 text-center">
                  <div className="text-base font-bold text-orange-600">{testimonial.startedWith}</div>
                  <div className="text-xs text-gray-600">Started with</div>
                </div>
              </div>
            </div>
          ))}
