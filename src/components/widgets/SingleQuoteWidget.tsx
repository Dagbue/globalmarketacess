 ...
 * Displays a single quote overview for a specified symbol (e.g., NASDAQ:AAPL) with customizable options.
 */
const SingleQuoteWidget: React.FC<SingleQuoteWidgetProps> = ({
                                                                 symbol = 'NASDAQ:AAPL',
                                                                 colorTheme = 'dark',
                                                                 isTransparent = false,
                                                                 locale = 'en',
...
export default SingleQuoteWidget;