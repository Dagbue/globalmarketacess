 ...
 * Displays a single quote overview for a specified symbol (e.g., NASDAQ:NVDA) with customizable options.
 */
const SingleQuoteWidget3: React.FC<SingleQuoteWidgetProps> = ({
                                                                  symbol = 'NASDAQ:NVDA',
                                                                  colorTheme = 'dark',
                                                                  isTransparent = false,
                                                                  locale = 'en',
...
export default SingleQuoteWidget3;