...
const ForexWidget = () => {
                ...
                script.onload = () => {
                    ...
                    if (window.TradingView) {
                        ...
                        new window.TradingView.widget({
                            ...
                            utm_medium: 'widget',
                            utm_campaign: 'chart',
                            utm_term: 'OANDA:USDCAD',
                        });
                        isScriptLoaded.current = true;
                        setIsLoading(false);
                        console.log('TradingView Forex widget initialized');
                    } else {
    ...
    return (
        ...
        >
            ...
            <div
                id="tradingview_forex_chart"
                ref={widgetContainerRef}
                className="tradingview-widget-container__widget"
                style={{
                    width: '100%',
                    height: isMobile ? '500px' : '100%', // 400px height on mobile, 100% on desktop
                    margin: 0,
                    padding: 0,
                }}
            ></div>
